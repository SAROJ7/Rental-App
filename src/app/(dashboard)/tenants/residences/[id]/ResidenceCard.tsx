...
const ResidenceCard = ({ property, currentLease }: ResidenceCardProps) => {
  return (
    <div className="bg-white rounded-xl shadow-md overflow-hidden p-6 flex flex-1 flex-col justify-between">
      {/* Headers */}
      <div className="flex gap-5">
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="text-xl font-bold">
            ${currentLease.rent}{" "}
            <span className="text-gray-500 texl-sm font-normal">/ night</span>
          </div>
        </div>
      </div>
