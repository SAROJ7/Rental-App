...
import { useGetPaymentsQuery, useGetPropertyLeasesQuery } from "@/queries";
...
const PropertyTenants = () => {
  ...
  const getCurrentMonthPaymentStatus = (leaseId: number) => {
    ...
    const currentPaymentMonth = payments?.find(
      (payment) =>
    ...
    return currentPaymentMonth?.paymentStatus || "Not Paid";
  };
          ...
          <div className="flex justify-between items-center mb-4">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Manager and view all tenants for this property
              </p>
            </div>
            <div>
              <button
                className={`border border-gray-300 text-gray-700 py-2 px-4 rounded-md flex items-center justify-center hover:bg-primary-700 hover:text-primary-50`}
              >
