...
import { initialStore, useGlobalStore } from "@/store/global.store";
...
const FiltersFull = () => {
  ...
  const [localFilters, setLocalFilters] = useState(initialStore.filters);
  ...
  const handleReset = () => {
    setLocalFilters(initialStore.filters);
    resetFilters();
    updateURL(initialStore.filters);
  };
  ...
  return (
    <div className="bg-white rounded-lg px-4 h-full overflow-auto pb-10">
      <div className="flex flex-col space-y-6">
        ...
        {/* SquareFeet */}
        <div>
          <h4 className="font-bold mb-2">SquareFeet</h4>
          <Slider
            min={0}
            max={5000}
            step={100}
              ...
              <div
                ...
                className={cn(
                  ...
                  localFilters.amenities.includes(amenity as AmenityEnum)
                    ? "border-white bg-black text-primary-50"
                    : "border-gray-200"
                )}
