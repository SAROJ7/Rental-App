            ...
            <>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger className="flex items-center gap-2 focus:outline-none">
                  <Avatar>
                    <AvatarImage src={authUser.data?.userInfo?.image} />
                    <AvatarFallback className="bg-primary-600">
                      {authUser.data?.userRole?.[0].toUpperCase()}
                    </AvatarFallback>
                  </Avatar>
                  <p className="text-primary-200 hidden md:block">
                ...
                <DropdownMenuContent className="bg-white text-primary-700">
                  <DropdownMenuItem
                    ...
                    onClick={() =>
                      router.push(
                        authUser.data?.userRole === "manager"
                          ? "/managers/properties"
                          : "/tenants/favorites",
                        { scroll: false }
                      )
                  ...
                  <DropdownMenuItem
                    ...
                    onClick={() =>
                      router.push(
                        `/${authUser.data?.userRole.toLowerCase()}s/settings`,
                        { scroll: false }
                      )
                    }
                  >
